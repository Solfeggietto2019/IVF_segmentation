    ...
    for sid_item, aeris_item in zip(siD_list, aeris_list):
        ...
        request_data = {
            "body": {
                ...
                "cyto_eccentricity": egg_features_parameters.get("cyto_eccentricity", 0),
                "cyto_area": egg_features_parameters.get("cyto_area", 0),
                "granu_minor_minoraxis": egg_features_parameters.get("granu_minor_minoraxis", 0),
                "granu_majoraxis": egg_features_parameters.get("granu_majoraxis", 0),
                "granu_eccentricity": egg_features_parameters.get("granu_eccentricity", 0),
                "granu_area": egg_features_parameters.get("granu_area", 0),
                "granu_area_rel": egg_features_parameters.get("granu_area_rel", 0),
                "polarbody_minor_minoraxis": egg_features_parameters.get("polarbody_minor_minoraxis", 0),
                "polarbody_majoraxis": egg_features_parameters.get("polarbody_majoraxis", 0),
                "polarbody_eccentricity": egg_features_parameters.get("polarbody_eccentricity", 0),
                "polarbody_area": egg_features_parameters.get("polarbody_area", 0),
                "peri_cyto_minoraxis": egg_features_parameters.get("peri_cyto_minoraxis", 0),
                "peri_cyto_majoraxis": egg_features_parameters.get("peri_cyto_majoraxis", 0),
                "peri_cyto_eccentricity": egg_features_parameters.get("peri_cyto_eccentricity", 0),
                "peri_cyto_area": egg_features_parameters.get("peri_cyto_area", 0),
                "zp_peri_cyto_minoraxis": egg_features_parameters.get("zp_peri_cyto_minoraxis", 0),
                "zp_peri_cyto_majoraxis": egg_features_parameters.get("zp_peri_cyto_majoraxis", 0),
                "zp_peri_cyto_eccentricity": egg_features_parameters.get("zp_peri_cyto_eccentricity", 0),
                "zp_peri_cyto_area": egg_features_parameters.get("zp_peri_cyto_area", 0),
                ...
                "major_axis_radius": morphological_parameters.get("major_axis_radius", 0),
                "minor_axis_radius": morphological_parameters.get("minor_axis_radius", 0),
            },
            "validation_key": "peromiraquematangadijolachanga"
        }
